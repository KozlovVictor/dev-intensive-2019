...
class CircleImageView @JvmOverloads constructor(
    ...
    private val paintBackground = Paint().apply { isAntiAlias = true }
    private var circleCenter = 0
    private var heightCircle = 0

    private var borderWidth: Int = Utils.dpToPx(context, DEFAULT_BORDER_WIDTH)
    ...
    init {
        if (attrs != null) {
            ...
            borderWidth = a.getDimensionPixelSize(
                ...
                Utils.dpToPx(context, DEFAULT_BORDER_WIDTH)
            )
